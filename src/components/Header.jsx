    ...
    <div className='sticky top-0 z-10 flex  h-14 flex-row items-center justify-between px-4 md:px-5 bg-white'>
      ...
      <div className='flex h-5 items-center'>
        {pageName !== 'video' && (
          ...
          >
            {mobileMenu ? <CgClose className='text-xl text-white' /> : <SlMenu className='text-xl text-black/80' />}
          </div> 
        )}
        <Link to='/' className='flex items-center'>
          <div className='h-6 md:h-7'>
            <svg
              ...
              focusable='false'
              className='style-scope yt-icon hidden md:block'
            ...
            <img className='block h-full md:hidden' src={ytLogoMobile} alt='Youtube' />
          </div>
        </Link>
      </div>
      ...
      <div className='group flex  items-center  overflow-hidden'>
        <div className='flex h-8 rounded-l-3xl border border-[#303030] group-focus-within:border-blue-500 md:ml-10 md:h-10 md:pl-5 md:group-focus-within:ml-5 md:group-focus-within:pl-0'>
          <div className='hidden w-10 items-center justify-center group-focus-within:md:flex'>
            <IoIosSearch className='cursor-pointer text-xl text-gray-800' />
          </div>

          <input
            type='text'
            className='text-gray-800pr-5 w-44 bg-transparent pl-5 outline-none md:w-64 md:pl-0 md:group-focus-within:pl-0 lg:w-[500px]'
            placeholder='Search'
        ...
        <button
          className='flex h-8 w-[40px] items-center justify-center rounded-r-3xl border border-l-0 border-[#303030] bg-gray-700/[0.1] md:h-10 md:w-[60px]'
          onClick={() => searchQueryHandler('searchButton')}
        >
          <IoIosSearch className='cursor-pointer text-2xl text-gray-800' />
        </button>
      </div>

      <div className='flex items-center'>
        <div className='flex'>
          <div className='flex h-10 w-10 items-center justify-center rounded-full text-red-400 hover:bg-slate-300/40'>
            <RiVideoAddLine className='cursor-pointer text-2xl text-[#201f1f]' />
          </div>
          <div className='mx-2 flex h-10 w-10 items-center justify-center rounded-full hover:bg-slate-300/40'>
            <FiBell className='cursor-pointer text-2xl text-[#201f1f]' />
          </div>
        </div>
        <div className='flex h-8 w-8 overflow-hidden rounded-full md:ml-4'>
          <img src='https://xsgames.co/randomusers/assets/avatars/female/67.jpg' alt='female' />
        </div>
      </div>
    </div>
  )
